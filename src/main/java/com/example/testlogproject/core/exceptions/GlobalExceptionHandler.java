package com.example.testlogproject.core.exceptions;

import java.util.HashMap;
import java.util.Map;

import com.example.testlogproject.core.utilities.results.ErrorDataResult;
...
public class GlobalExceptionHandler {
	...
	@ResponseStatus(code = HttpStatus.BAD_REQUEST)
	public ErrorDataResult<Object> handleValidationException(MethodArgumentTypeMismatchException argumentTypeMismatchException){
